...
A45=0.5*[1 1;1 1];A135=0.5*[1 -1;-1 1];
A0=[1 0;0 0];A90=[0 0;0 1];
ACD=0.5*[1 1i;-1i 1];ACL=0.5*[1 -1i;1i 1];

NN=size(Ex);st=4;
E(:,:,1)=Ex(1:st:NN(1),1:st:NN(2));E(:,:,2)=Ey(1:st:NN(1),1:st:NN(2));
N=size(E);
I0a=zeros(N);I135a=I0a;I45a=I0a;I90a=I45a;ICDa=I0a;ICLa=I0a;
JV=[0;0];
...
for ii=1:N(1)
    tic
    for jj=1:N(2)
        JV(1)=E(ii,jj,1);JV(2)=E(ii,jj,2);%JV=[Ex(ii,jj);Ey(ii,jj)];%
        E0=A0*JV;
...
figure;subplot(2,3,1);imagesc(I0',[0 1]);title 'I0'
