...
makeHolo=1;
for macropixel=2;%[2 4 44] % (2) for a simple Arizon's procedure and (4) for amplied 
...
if(makeDesign==1)
    [h_T1,h_T2,h_ph1,h_ph2]=scripts.beam_design(SLM_size,beam_type,designINfile,0,0);
else
...
if makeHolo~=0
    if macropixel==2
        [hologram_SLM1,hologram_SLM2]=scripts.mapa_Holo(h_T1,h_T2,h_ph1,h_ph2,Modulation);
    elseif macropixel==4
        [hologram_SLM1,hologram_SLM2]=scripts.mapa_Holo4(h_T1,h_T2,h_ph1,h_ph2);
        options=strcat(options,'_M4');
    elseif macropixel==44
        [hologram_SLM1,hologram_SLM2]=scripts.mapa_Holo44(h_T1,h_T2,h_ph1,h_ph2);
